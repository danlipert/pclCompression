...
public:
  ...
  cloud_cb_ (const pcl::PointCloud<pcl::PointXYZRGBA>::ConstPtr &cloud)
  {
    if (!viewer.wasStopped ())
    {
      ...
      // add newly compressed data to output file
      FILE * outfile = fopen("./compressed", "a+b");
      std::string * s = new string(compressedData.str());
      fwrite(s, sizeof(char), sizeof(s), outfile);
      fclose(outfile);
